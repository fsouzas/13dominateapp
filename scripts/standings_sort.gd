...
@export var standing_less : PanelContainer
...
func _ready() -> void:
	...
	if not HeroesDb.young_heroes[UniversalDict.merge_data.values()[0]["Hero"]]["background"]:
		...
		heroi_destaque1_bg.texture = load(HeroesDb.young_heroes[UniversalDict.merge_data.values()[0]["Hero"]]["background"])
	if HeroesDb.young_heroes[UniversalDict.merge_data.values()[0]["Hero"]]["front"] == "":
		heroi_destaque1_front.texture = load("res://assets/standing_destaque/unknown/unknown_front.png")
	else:
		heroi_destaque1_front.texture = load(HeroesDb.young_heroes[UniversalDict.merge_data.values()[0]["Hero"]]["front"])
	...
	if HeroesDb.young_heroes[UniversalDict.merge_data.values()[1]["Hero"]]["background"] == "":
		...
		heroi_destaque2_bg.texture = load(HeroesDb.young_heroes[UniversalDict.merge_data.values()[1]["Hero"]]["background"])
	if HeroesDb.young_heroes[UniversalDict.merge_data.values()[1]["Hero"]]["front"] == "":
		heroi_destaque2_front.texture = load("res://assets/standing_destaque/unknown/unknown_front.png")
	else:
		heroi_destaque2_front.texture = load(HeroesDb.young_heroes[UniversalDict.merge_data.values()[1]["Hero"]]["front"])
	...
	if HeroesDb.young_heroes[UniversalDict.merge_data.values()[2]["Hero"]]["background"] == "":
		...
		heroi_destaque3_bg.texture = load(HeroesDb.young_heroes[UniversalDict.merge_data.values()[2]["Hero"]]["background"])
	if HeroesDb.young_heroes[UniversalDict.merge_data.values()[2]["Hero"]]["front"] == "":
		heroi_destaque3_front.texture = load("res://assets/standing_destaque/unknown/unknown_front.png")
	else:
		heroi_destaque3_front.texture = load(HeroesDb.young_heroes[UniversalDict.merge_data.values()[2]["Hero"]]["front"])
...
func _process(delta: float) -> void:
	pass
func sort_standing():
	for i in range(3, UniversalDict.merge_data.size()):
		var temp_standing_less = standing_less.duplicate()
		vbox.add_child(temp_standing_less)
		if HeroesDb.young_heroes[UniversalDict.merge_data.values()[i]["Hero"]]["standing"] == "":
